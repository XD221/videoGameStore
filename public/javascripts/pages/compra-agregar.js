...
$(document).ready(function () {
  $.each($("#tbl tbody").find("tr"), (key, value) => {
    $(value)
      .find("#btnEliminar_" + $(value).attr("id").split("_")[1])
      .click(function () {
        ...
        solicitudAjax(
          ...
          (result) => {
            if (result.Success) {
              toastr.success(
                "Producto de la lista se ha eliminado satisfactoriamente"
              );
              return;
            }
  ...
  $tbl = $("#tbl").DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        filename: "Reporte de Compra",
        title: "Reporte de Compra",
        messageTop: "Reporte de compra FECHA:" + day + "/" + month +"/" + year
      },
    ],
  });
      ...
      (result) => {
        if (result.Success) {
          ...
          if (!duplicate) {
            ...
            $(ultimaFila)
              .off()
              .find("#btnEliminar_" + $(ultimaFila).attr("id").split("_")[1])
              .click(function () {
                var url = "/compra/agregar";
                var tipo = "DELETE";
                ...
                solicitudAjax(
                  ...
                  (result) => {
                    ...
                    toastr.error(
                      "El producto de la lista no existe en la lista"
                    );
                  },
                  datos,
                  tipoDatos,
          ...
          toastr.error(
            "El producto no se agrego al carrito de compra por datos invalidos"
          );
        }
      },
      datos,
