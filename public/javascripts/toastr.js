			...
			var version = '1.3.1',
				...
				defaults = {
					...
					iconClasses: {
						error: 'toastXD-error',
						info: 'toastXD-info',
						success: 'toastXD-success',
						warning: 'toastXD-warning'
					},
					iconClass: 'toastXD-info',
					positionClass: 'toastXD-top-right',
					timeOut: 1000, // Set timeOut and extendedTimeout to 0 to make it sticky
					titleClass: 'toastXD-title',
					messageClass: 'toastXD-message',
					target: 'body',
					newestOnTop: true
				},
